...
const Dashboard = (props: Props) => {
  return (
   ...
   <body className="">
    <div className="flex">
        <div className="w-40 h-[1250px] bg-gradient-to-r from-[#4E7C32] to-[#b0b5a1] text-white flex flex-col">
            ...
            <div className="p-4">
                <button className="w-full py-2 bg-[#4E7C32] hover:bg-blue-700 rounded">Logout</button>
            </div>
        </div>
        <div className="flex-1 flex flex-col">
            <header className="bg-white shadow p-4">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-[#4E7C32]">Dashboard</h1>
