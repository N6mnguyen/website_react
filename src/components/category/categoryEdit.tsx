  ...
  return (
    <>
        ...
        <form className='flex flex-col py-12 w-[500px] mx-auto gap-4'onSubmit={handleSubmit(onSubmit)}>
            <input className='py-2 px-4 border border-2 rounded-[20px]' type='text' {...register('name')} placeholder='Tên sản phẩm' />
            <button className='py-2 bg-blue-800 text-white font-bold rounded-[20px] ' type='submit'>Cập nhật</button>
        </form>
    </>
  )
}
